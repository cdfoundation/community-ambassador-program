...
C\ **Consequences of Unacceptable Behavior**
...
\ **About the CD Foundation**
*Continuous delivery (CD) is a software engineering approach in which teams produce software in short cycles, ensuring that the software can be reliably released at any time. The Continuous Delivery Foundation (CD Foundation) serves as the vendor-neutral home of many of the fastest-growing projects for continuous delivery, including Jenkins and Jenkins X, as well as fosters collaboration between the industry’s top developers, end users and vendors to further continuous delivery best practices. CD Foundation is part of The Linux Foundation, a nonprofit organization. For more information about the CD Foundation, please visit https://cd.foundation.*
*Copyright © 2020 The Linux Foundation®. All rights reserved. The Linux Foundation has registered trademarks and uses trademarks. For a list of trademarks of The Linux Foundation, please see our Trademark Usage page. Linux is a registered trademark of Linus Torvalds.*
